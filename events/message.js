  ...
  if (message.author.bot || !message.content.startsWith(config.prefix)) return;
   ...
   let creation = ms(Date.now() - message.author.createdTimestamp, { long: true })
     ...
     .addFields(
       ...
       { name: "Account Creation", value: `<t:${parseInt(message.author.createdAt / 1000)}:R>`, inline: false },
     ...
     message.author.send("Hola <@${message.author.id}> has creado un ticket, espera a que un moderador atienda tu caso. Mientras tanto, describe en qué te podemos ayudar y eventualmente te ayudarán.<a:_:1021918735071727647>").catch(() => {})
