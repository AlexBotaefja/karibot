...
module.exports = async (message, args, user, channel, anonymous, client) => {
  ...
  .setColor("#96f7b0")
  .setFooter("El mal uso de este medio conllevará una sanción ┊ El staff nunca te preguntará por tu correo, contraseña, números telefónicos y/o tokens" message.author.avatarURL())
